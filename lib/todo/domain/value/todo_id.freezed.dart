...
class _$_TodoId with DiagnosticableTreeMixin implements _TodoId {
  _$_TodoId([this.value]);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'TodoId'))
...
abstract class _TodoId implements TodoId {
  factory _TodoId([final String? value]) = _$_TodoId;
